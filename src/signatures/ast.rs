...
impl std::str::FromStr for Protocol {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s.to_lowercase().as_str() {
            ...
            "ntp" => Ok(Protocol::Ntp),
            "nfs" => Ok(Protocol::Nfs),
            "kerberos" | "krb5" => Ok(Protocol::Kerberos),
            "rdp" => Ok(Protocol::Rdp),
            ...
            "enip" => Ok(Protocol::Enip),
            "rfb" | "vnc" => Ok(Protocol::Rfb),
            "ike" | "isakmp" => Ok(Protocol::Ike),
            "any" => Ok(Protocol::Any),
...
impl std::fmt::Display for Protocol {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Protocol::Enip => write!(f, "enip"),
            Protocol::Rfb => write!(f, "rfb"),
            Protocol::Ike => write!(f, "ike"),
